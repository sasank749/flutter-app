      ...
      body:  Center(
        child: Column(
          children: <Widget>[
            ...
            Text('Type',style: TextStyle(height: 1, fontSize:20,color: Colors.redAccent),),
            SizedBox(height: 20,),

            DropdownButton<Item>(
              hint:  Text("Type",style: TextStyle(height: 1, fontSize:20,color: Colors.green)),
              value: selectedUser,
            ...
            SizedBox(height: 20,),
            Text('Home Town',style: TextStyle(height: 1, fontSize:20,color: Colors.redAccent)),
            SizedBox(height: 20,),

            DropdownButton<Item>(
              hint:  Text("City",style: TextStyle(height: 1, fontSize:20,color: Colors.green)),
              value: selectedUser1,
              onChanged: (Item Value) {
                setState(() {
                  selectedUser1 = Value;
            ...
            Text('Society',style: TextStyle(height: 1, fontSize:20,color: Colors.redAccent)),
            SizedBox(height: 20,),
            TextFormField(
